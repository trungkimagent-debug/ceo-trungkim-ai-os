...
export async function uploadThuGopAsset(file, options = {}) {
  ...
  const payload = await callThuGopInternalApi("/internal/pos/thugop-goc/uploads", {
    method: "POST",
    body: {
...
export async function createThuGopTicket(data = {}) {
  const payload = await callThuGopInternalApi("/internal/pos/thugop-goc/tickets", {
    method: "POST",
    body: data,
  });
  return {
...
export function updateThuGopTicket(ticketId, data = {}) {
  return callThuGopInternalApi(`/internal/pos/thugop-goc/tickets/${encodeURIComponent(String(ticketId || "").trim())}`, {
    method: "PATCH",
    body: data,
  });
}
...
export function markThuGopCollectedPayment(ticket = {}, payment = {}, actor = {}) {
  ...
  return callThuGopInternalApi(`/internal/pos/thugop-goc/tickets/${encodeURIComponent(ticketId)}/collect-payment`, {
    method: "POST",
    body: {
      amount,
      billUrl,
...
export async function approveThuGopCashHandoverBatch(selectedTickets = [], actor = {}) {
  ...
  return callThuGopInternalApi("/internal/pos/thugop-goc/handover-batches/approve", {
    method: "POST",
    body: {
